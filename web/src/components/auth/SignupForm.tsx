...
export default function SignupForm() {
  ...
  return (
    <div className="mx-auto w-full max-w-sm">
      ...
      <p className="mb-8 text-sm text-navy-400">Get started with Pixshift for free</p>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div>
          <label htmlFor="name" className="mb-1 block text-sm text-navy-400">Name</label>
          <input
            id="name"
            type="text"
            required
      ...
      <p className="mt-6 text-center text-sm text-navy-400">
        ...
        <Link to="/login" className="text-accent hover:text-accent-light">Sign in</Link>
      </p>
    </div>
  );
}
